...
parser.add_argument('--len1',  '-l1',
                    dest="length1",
                    type=int,
                    help =  'length defined to extract FBP over concatenated feature ',
                    default=6)       
...
def compute_scores(k, i, dataset_bio1, dataset_bio2, filter_keys_bio1, filter_keys_bio2, length_1, type_binary, bio1, bio2):
    ...
    for bio1,label_1,bio2,label_2 in zip(enrol_subjects_bio1_load, labels_subjects_bio1, enrol_subjects_bio2_load, labels_subjects_bio2):
        concatenated_feat = enrolment.concatenation_features_subjects(bio1, bio2, None,2)
        max_code = frequent_pattern_search.max_occurrence_search_per_subject_concatenated_feat(concatenated_feat, K_combinations,length_1, 0)
        enrolment.save_binning_concat_feat_open_set(max_code, bio1, bio2, None, 2) #---> open-set
    ...
    for bio1, label_1, bio2, label_2 in zip(search_subjects_bio1_load, labels_subjects_bio1, search_subjects_bio2_load, labels_subjects_bio2):
        ...
        concatenated_feat_retrieval = enrolment.concatenation_features_subjects(bio1, bio2, None, 2)
...
with open(save_path_csv, 'w', newline='') as file:
    ...
    fieldnames = ['btp','eer','alpha_best','workload']
    ...
    writer_face.writerow({'btp': type_binary,'eer': best_eer,'workload': pr_step})
